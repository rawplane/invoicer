...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function register(): void
    {
        ...
        $validated['subscription_plan'] = 'free_trial';
...
<div>
    <form wire:submit="register">
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model="business_name" id="business_name" class="block mt-1 w-full" type="text" name="business_name" required autocomplete="organization" />
