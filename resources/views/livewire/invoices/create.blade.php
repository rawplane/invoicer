        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form wire:submit="save" class="space-y-6">
                    ...
                    <!-- Line Items Header & Dynamic Inputs -->
                    <div class="mt-8">
                    ...
                    <div>
                        ...
                        <textarea wire:model="notes" id="notes" class="mt-1 block w-full border-slate-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" rows="3" placeholder="Transfer ke rekening BCA 123456789 a.n Toko Berkah"></textarea>
