            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form wire:submit="save" class="space-y-6">
                    <div>
                        ...
                        <x-text-input wire:model="title" id="title" type="text" class="mt-1 block w-full" placeholder="misal: Pembelian Kertas HVS & Tinta Printer" required />
                    ...
                    <div>
                        <x-input-label for="receipt" :value="__('Upload Bukti / Nota (Opsional, Max 2MB)')" />
